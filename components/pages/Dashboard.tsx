...
export function RealtimeTab({ data }: { data: DashboardData }) {
  ...
  const [selectedLiveClick, setSelectedLiveClick] = useState<Click | null>(
    null
  );
                ...
                >
                  ...
                  <div className="space-y-4 text-zinc-700 dark:text-zinc-300 text-sm">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="font-mono break-words">
                        {whatIsMyIP?.city}, {whatIsMyIP?.region},{" "}
                        {whatIsMyIP?.postal}
                      </span>
                    </div>
      ...
      <div className="overflow-x-auto rounded-xl shadow-md mt-4 border border-zinc-200 dark:border-zinc-700">
        <table className="table-auto min-w-full divide-y divide-zinc-200 dark:divide-zinc-700 text-sm">
          <thead className="bg-gradient-to-r from-blue-500 via-purple-500 to-amber-500 text-white dark:bg-zinc-800 dark:text-zinc-300">
            <tr>
              <th className="px-4 py-1 text-left font-semibold whitespace-nowrap">
                User
              </th>
              <th className="px-1 py-1 text-left font-semibold whitespace-nowrap">
                Country
              </th>
              <th className="px-1 py-1 text-left font-semibold whitespace-nowrap">
                Network
              </th>
              <th className="px-4 py-1 text-left font-semibold whitespace-nowrap hidden md:table-cell">
                Source
              </th>
              <th className="px-4 py-1 text-left font-semibold whitespace-nowrap">
                Earning
              ...
              <th className="px-4 py-1 text-left font-semibold whitespace-nowrap hidden sm:table-cell">
                Time
              </th>
            </tr>
          </thead>
            ...
            >
              ...
              <div className="space-y-4 text-zinc-700 dark:text-zinc-300 text-sm">
                ...
                <div className="flex items-center space-x-3">
                  <MapPin className="w-4 h-4 text-red-500" />
                  <span className="font-mono text-1xl">
                    {whatIsMyIP?.region}, {whatIsMyIP?.city},{" "}
                    {whatIsMyIP?.postal}
                  </span>
                </div>
                {/* Earning */}
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-2 text-sm text-gray-700 dark:text-gray-300">
                        <span className="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded-lg">
                          Lead:{" "}
                          <span className="font-bold">{item.totalLeads}</span>
                        </span>
                        <span className="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded-lg">
                          Click:{" "}
                          <span className="font-bold">{item.totalClicks}</span>
                        </span>
                        <span className="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded-lg">
